...
document.querySelector("#footertext").innerHTML = `&copy;${currentyear} Beauty Products Chamber ║ David Kikiani ✧ ║ WDD 230 Project ║ Last modification: ${document.lastModified}`;
