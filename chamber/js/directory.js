const requestURL = 'https://davidkikiani.github.io/wdd230/lesson9/json/data.json';
...
function displayAffiliates(data) {
  ...
  data.affiliates.forEach(affiliate => {
    ...
    image.setAttribute('alt', `Company logo of ${affiliate.name}, Beauty Products Chamber of Commerce Affiliiate`);
